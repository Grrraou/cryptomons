...
export const monstersEnum: Monster[] = [
    ...
    { index: 'scammer_troll', name: 'Scammer Troll', description: "Don't trust everyone", power: 2, loot: { index: 'binance-fortress-plate', ratio: 0.02 } },
    ...
    { index: 'shill_serpent', name: 'Shill Serpent', description: 'Tempts you with empty promises', power: 4, loot: { index: 'kraken-fortress-gloves', ratio: 0.02 } },
    ...
    { index: 'dusting_demon', name: 'Dusting Demon', description: 'Leaves traces to track you', power: 4, loot: { index: 'kraken-fortress-boots', ratio: 0.02 } },
    ...
    { index: 'crypto_clown', name: 'Crypto Clown', description: 'Turns serious investments into a joke', power: 4, loot: { index: 'kraken-fortress-pants', ratio: 0.02 } },
    { index: 'wallet_wraith', name: 'Wallet Wraith', description: 'Drains your funds without a trace', power: 8, loot: { index: 'good_news', ratio: 0.001 } },
    ...
    { index: 'airdrop_angel', name: 'Airdrop Angel', description: 'Gives you free tokens, but at what cost?', power: 15, loot: { index: 'uniswap-fortress-plate', ratio: 0.02 } },
    ...
    { index: 'mempool_mimic', name: 'Mempool Mimic', description: 'Hides in pending transactions', power: 15, loot: { index: 'uniswap-fortress-helmet', ratio: 0.02 } },
    ...
    { index: 'blockchain_banshee', name: 'Blockchain Banshee', description: 'Screams of lost keys and frozen assets', power: 15, loot: { index: 'uniswap-fortress-sword', ratio: 0.02 } },
    { index: 'altcoin_abomination', name: 'Altcoin Abomination', description: 'A twisted creation, volatile and unpredictable', power: 20, loot: { index: 'good_news', ratio: 0.001 } },
    ...
    { index: 'paper_wallet_poltergeist', name: 'Paper Wallet Poltergeist', description: 'Haunts forgotten backups', power: 30, loot: { index: 'pancake-fortress-gloves', ratio: 0.02 } },
    ...
    { index: 'oracle_ogre', name: 'Oracle Ogre', description: 'Feeds false data to smart contracts', power: 30, loot: { index: 'pancake-fortress-boots', ratio: 0.02 } },
    ...
    { index: 'token_troll', name: 'Token Troll', description: 'Lurks in obscure coins, waiting to trap victims', power: 30, loot: { index: 'pancake-fortress-pants', ratio: 0.02 } },
    { index: 'faucet_fairy', name: 'Faucet Fairy', description: 'Grants tiny amounts of crypto, but it adds up', power: 2, loot: { index: 'good_news', ratio: 0.001 } },
