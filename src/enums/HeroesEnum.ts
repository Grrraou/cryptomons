...
export const heroesEnum: Hero[] = [
    ...
    { index: 'pancakomon', name: 'Pancakomon', token: 'cake', requirement: 'buy_bittorent', baseBattlePower: 2, baseMiningPower: 4 },
    { index: 'degenomon', name: 'Degenomon', token: 'cryptodollar', requirement: 'yolo_or_fomo', baseBattlePower: 6, baseMiningPower: 6 },
    { index: 'harembe', name: 'Harembe', token: 'cryptodollar', requirement: 'play_the_lottery', baseBattlePower: 1, baseMiningPower: 5 },
